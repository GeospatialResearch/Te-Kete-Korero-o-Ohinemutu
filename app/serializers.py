...
class StorySerializer(ModelSerializer):
    ...
    hapu_temp = PrimaryKeyRelatedField(write_only=True,many=True,queryset=Nest.objects.all())
    ...
    def create(self, validated_data):
        ...
        hapus = validated_data.pop('hapu_temp')
